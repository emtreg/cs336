...
<%
	try {
		...
		ApplicationDB db = new ApplicationDB();	
			...
			String num = request.getParameter("customer_id");
			//Make a SELECT query from the sells table with the price range specified by the 'price' parameter at the index.jsp
			String str = "select user_id, count(ticket_num) num, sum(total_cost) total from Tickets where user_id='"+num+"'";
			...
			while (result.next()&&result.getString("user_id")!=null) {
				//make a row
				out.print("<tr>");
				//make a column
				out.print("<td>");
