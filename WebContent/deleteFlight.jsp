...
<body>
	...
	try {  
		...
		String str = "SELECT * FROM Flights WHERE flight_num = '" + flight_num + "'";
		...
		if(result.next()) {
			...
			String delete = "DELETE FROM Flights WHERE flight_num = '" + flight_num +  "'";
			...
			out.print("Flight number does not exist.");
		}
